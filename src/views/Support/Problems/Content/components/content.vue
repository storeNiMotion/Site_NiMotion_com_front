            ...
            <div class="support-detail">
                ...
                <div class="article">
                    <div class="detail-title">
                        <h1>{{ supportProblemsDetail.name }}</h1>
                        <div class="info-box">
                            <span class="author" v-if="supportProblemsDetail.author">{{ supportProblemsDetail.author
                                }}</span>
                            <span class="date">{{ supportProblemsDetail.release_time }}</span>
                        </div>
                    </div>
                    <div class="detail-content" v-html="supportProblemsDetail.content">
                    </div>
                    <div class="detail-footer">
                        <div class="article-tags" v-for="item in supportProblemsDetail.tag" :key="item.id">
                            <span>{{ item.tag }}</span>
                        </div>
                    </div>
                </div>
