...
const getAllSearchResult = async (key = route.params.key) => {
    ...
    SearchResult_sol.value = res.sol_data
    loading.value = false
...
<template>
    ...
    <el-tab-pane>
        ...
        <div class="">
            <div class="result">
                <div class="result-item" v-for="item in SearchResult_sol" :key="item.id">
                    ...
                    <div class="pic">
                        <div class="pic-box">
                            <RouterLink :to="`/solution/detail/${item.id}`"><img v-img-lazy="item.default_image"
                                    :alt="item.name"></RouterLink>
                        </div>
                    </div>
                    <div class="detail">
        ...
        <el-empty :image-size="200" description="No relevant content was found" v-if="isempty2" />
    </el-tab-pane>
